...
*/
router.put('/v1/products/:productId', productController.updateProduct); //or patch is OK, but I prefer put
...
*/
router.patch('/v1/sellers/block/:sellerId', sellerController.blockSeller);

/*
* An endpoint to search sellers based on seller name and product name
*/
router.get('/v1/sellers', sellerController.searchSellers);
